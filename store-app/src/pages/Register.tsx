...
export default function Register() {
  ...
  }, [email, password, storeName, address, cuisineType, register, navigate])
  ...
  return (
    <div className={styles.register}>
        ...
        <div className={styles.container10}>
          ...
          <div className={styles.container11}>
            <input
              ...
              placeholder="City, address and area"
              required
            />
            <svg className={styles.icon4} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10 18C10 18 15 12 15 8C15 5.239 12.761 3 10 3C7.239 3 5 5.239 5 8C5 12 10 18 10 18Z" stroke="#99a1af" strokeWidth="1.5" strokeLinecap="round"/>
              <circle cx="10" cy="8" r="2" stroke="#99a1af" strokeWidth="1.5"/>
            </svg>
          </div>
      ...
      <svg className={styles.registerItem} viewBox="0 0 250 274" fill="none" xmlns="http://www.w3.org/2000/svg">
